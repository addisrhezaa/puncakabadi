...
urlpatterns = [
    ...
    path("viewpemusnahanbarang", viewsproduksi.view_pemusnahanbarang, name="view_pemusnahanbarang"),
    path("addpemusnahanbarang", viewsproduksi.add_pemusnahanbarang, name="add_pemusnahanbarang"),
    path("updatepemusnahanbarang/<str:id>",viewsproduksi.update_pemusnahanbarang,name="update_pemusnahanbarang",),
    path("deletepemusnahanbarang/<str:id>",viewsproduksi.delete_pemusnahanbarang,name="delete_pemusnahanbarang",),
    ...
    path("updatesubkonkirim/<str:id>",viewsproduksi.update_subkonkirim,name="update_subkonkirim",),
    path("deletesubkonkirim/<str:id>",viewsproduksi.delete_subkonkirim,name="delete_subkonkirim",),
